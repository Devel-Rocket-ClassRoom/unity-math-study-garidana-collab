...
public class Assignment_CircularFormation : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < units.Length; i++)
        {
            ...
            // float angle = 360f / units.Length * i;
            // // TODO
            // Quaternion yAngleQuat = Quaternion.AngleAxis(angle, Vector3.up);
            // Quaternion formationRot = leader.rotation * yAngleQuat;
            // // TODO
            // var offset = formationRot * Vector3.forward * formationRadius;
    ...
    private void OnDrawGizmos()
    {
        ...
        // for (int i = 0; i < units.Length; i++)
        // {
        //     int next = (i + 1) % units.Length;
        //     if (units[i] == null || units[next] == null) continue;
        //     Gizmos.color = new Color (0.3f, 1f, 0.3f, 0.3f);
        //     Gizmos.DrawLine(units[i].position, units[next].position);
        // }
